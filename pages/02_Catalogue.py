...
# Ajouter le chemin parent au path pour pouvoir importer les modules
...
IS_LOCAL = os.path.exists(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "SGBD"))
...
def load_all_metadata():
    ...
    if IS_LOCAL:
        ...
        base_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "SGBD", "Metadata")
    else:
